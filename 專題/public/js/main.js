...
var account = prompt('Enter account :');
var room =account;
var password = prompt('Enter password :');
document.getElementById("choice_box").style.visibility="visible"
...
function submit()
    {
      document.getElementById("num").innerHTML='生成中';
      var question_name =[]
      var question_num =[]
      var choice_num=[]
      var question_number = document.getElementsByClassName("question_number")[0].value;
      for(var i=0;i<6;i++)
      {
        question_name[i]= document.getElementsByClassName("question")[i].name;
        question_num[i]= document.getElementsByClassName("question")[i].value; 
        choice_num[i]= document.getElementsByClassName("choice_num")[i].value; 
      }
      google.script.run.withSuccessHandler(
        function(test){
          document.getElementById("num").innerHTML=test;
      }).createForm(question_name,question_num,question_number,choice_num);
    }
